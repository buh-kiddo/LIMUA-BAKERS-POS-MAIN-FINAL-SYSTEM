<?php require views_path('partials/header');?>
	...
	<div class="d-flex">
		...
		<div class="col-5 bg-light p-4 pt-2">
			...
			<div class="js-gtotal alert alert-danger" style="font-size:30px">Total: Kes 0.00</div>
			<div class="">
...
<script>
	...
	function send_data(obj, onSuccess)
	{
		var prog = document.querySelector(".js-prog");
		if(prog){
			prog.children[0].style.width = "100%";
		...
		return `
			...
			<div class="card m-2 border-0 mx-auto" style="min-width: 190px;max-width: 190px;">
				...
				<div class="p-2">
					...
					<div class="" style="font-size:20px"><b>Kes ${data.amount}</b></div>
				</div>
			</div>
			<!--end card-->
			`;
	...
	function refresh_items_display()
	{
		...
		gtotal_div.innerHTML = "Total: Kes " + grand_total.toFixed(2);
		GTOTAL = grand_total;
